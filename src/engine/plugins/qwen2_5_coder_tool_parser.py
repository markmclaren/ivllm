...
try:
    ...
    try:
        from vllm.entrypoints.openai.tool_parsers.abstract_tool_parser import (  # type: ignore[no-redef]
            ToolParser,
            ToolParserManager,
        )
    except ImportError:
        from vllm.entrypoints.openai.tool_parsers import (  # type: ignore[no-redef]
            ToolParser,
            ToolParserManager,
        )
...
@ToolParserManager.register_module(["qwen2_5_coder", "qwen_2_5"])
